...
public class MainActivity extends AppCompatActivity {
    ...
    private Drawable mapWeatherTDrawable(String forecast) {
        int drawableId = 0;
        switch (forecast) {
            case "sun":
    ...
    private void loadForecast(List<String> forecasts) {
        ...
        for(int i = 0; i < forecastView.getChildCount(); i++) {
            ...
            dayView.setImageDrawable(mapWeatherTDrawable(forecasts.get(i)));
        }
    }
